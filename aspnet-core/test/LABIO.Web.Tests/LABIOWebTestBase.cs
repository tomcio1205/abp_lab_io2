...
{
    public abstract class LABIOWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LABIOWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LABIOWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LABIODbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LABIODbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LABIODbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LABIODbContext, Task<T>> func)
        {
            T result;
